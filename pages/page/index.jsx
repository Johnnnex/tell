        ...
        <main className={`${inter.className} pt-[10vh]`}>
          ...
          <section id="mission" className="py-[81px] bg-white">
            <div className="md:w-[85%] w-[90%] flex flex-col-reverse md:flex-row items-center gap-[80px] mx-auto">
              ...
              <div className="flex-1">
                <div className="flex wow fadeIn items-center mb-[32px] gap-[24px]">
          ...
          <section className="pt-[80px] pb-[60px] bg-[#FBF6F6]">
            <div className="md:w-[88%] w-[90%] mx-auto">
              <h2 className="mb-[74px] wow fadeIn text-[#000000] md:text-[40px] text-[24px] font-[600] text-center">{t("values.heading")}</h2>
              <div className="grid md:grid-cols-2 grid-cols-1 gap-x-[18px] gap-y-[16px] md:gap-y-[24px] mb-[56px]">
                <div className="bg-[url('/images/values-1.png')] wow fadeIn rounded-[8px] md:rounded-none bg-center bg-cover bg-no-repeat bg-blend-overlay bg-[#000000B2] border border-black pt-[219px] pl-[27px] pb-[37px]">
                ...
                <div className="border bg-[url('/images/values-2.png')] wow fadeIn rounded-[8px] md:rounded-none bg-center bg-cover bg-no-repeat bg-blend-overlay bg-[#000000B2] border-black pt-[219px] pl-[27px] pb-[37px]">
                  <h3 className="text-white font-[600] md:text-[30px] text-[18px] mb-[24px]">{t("values.cardTwo.heading")}</h3>
                  <p className="md:text-[18px] text-[16px] text-white w-[90%] font-[400] leading-[27px]">
                    {t("values.cardTwo.text")}
                  </p>
                </div>
                <div className="border bg-[url('/images/values-3.png')] wow fadeIn rounded-[8px] md:rounded-none bg-center bg-cover bg-no-repeat bg-blend-overlay bg-[#000000B2] border-black pt-[219px] pl-[27px] pb-[37px]">
                  <h3 className="text-white font-[600] md:text-[30px] text-[18px] mb-[24px]">{t("values.cardThr.heading")}</h3>
                  <p className="md:text-[18px] text-[16px] text-white w-[90%] font-[400] leading-[27px]">
                    {t("values.cardThr.text")}
                  </p>
                </div>
                <div className="border bg-[url('/images/values-4.png')] wow fadeIn rounded-[8px] md:rounded-none bg-center bg-cover bg-no-repeat bg-blend-overlay bg-[#000000B2] border-black pt-[219px] pl-[27px] pb-[37px]">
          ...
          <section id="about" className="py-[91px] bg-white">
            <h2 className="text-black wow fadeInDown font-[600] md:text-[40px] text-[24px] text-center mb-[24px]">{t("whoWeAre.heading")}</h2>
            <p className="leading-[21.6px] wow fadeIn text-[#595959] md:text-[18px] text-[16px] font-[400] md:w-[60%] w-[85%] mb-[62px] mx-auto text-center">
              {t("whoWeAre.text")}
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-[24px] gap-y-[32px] md:w-[85%] w-[90%] mx-auto">
              <div className="px-[15px] wow fadeIn py-[10px] border border-[#A49E9E69] rounded-[16px]">
          ...
          <section className="py-[44px] bg-[#FBF6F6]">
            <div className="md:w-[85%] w-[90%] mx-auto">
              <h2 className="md:text-[40px] wow fadeInDown text-[24px] font-[600] text-[#05120B] mb-[60px] text-center">{t("help.heading")}</h2>
              <div className="flex flex-col md:flex-row gap-[16px] items-center">
                <div className="h-[569px] text-white flex items-center flex-col justify-center w-full rounded-[8px] md:rounded-none py-[93px] md:py-0 flex-1 bg-blend-overlay bg-[#0705119C] bg-cover bg-center bg-[url('/images/donation.png')]">
                  <div className="w-fit mx-auto">
                    ...
                    <ul className="list-inside wow fadeIn space-y-[16px] text-[18px] font-[400] mb-[34px] list-disc">
                ...
                <div className="flex-1 py-[93px] md:py-0 w-full rounded-[8px] md:rounded-none h-[569px] text-white flex items-center flex-col justify-center bg-blend-overlay bg-[#0705119C] bg-cover bg-center bg-[url('/images/prayer.png')]">
                  <div className="w-fit mx-auto">
                    <h2 className="text-white wow fadeInDown mb-[16px] text-[32px] text-center font-[600]">{t("help.cardTwo.heading")}</h2>
                    <ul wow fadeIn className="list-inside text-[18px] font-[400] mb-[34px] list-disc">
          ...
          <section className="pt-[78px] pb-[63px] bg-white">
            <div className="md:w-[85%] w-[90%] justify-between flex-col md:flex-row flex mx-auto">
              <div className="md:w-[40%] md:text-white md:bg-[url('/images/values-2.png')] md:bg-center md:bg-cover md:bg-no-repeat md:bg-blend-overlay md:bg-[#00000099] md:px-[32px] md:flex md:flex-col md:items-center justify-center">
                <div>
                  <h2 className="mb-[32px] wow fadeIn text-[24px] text-[#05120B] md:text-inherit md:text-[30px] font-[700]">{t("getInTouch.heading")}</h2>
                  <address className="leading-[24px] mb-[24px] text-[#595959] md:text-inherit font-[400] text-[16px]">
                    6 Lower Clarence Road <br />
                    Norwich
                  </address>
                  <div className="flex wow fadeIn md:text-white text-[16px] text-[#595959] font-[400] mb-[12px] gap-[12px]">
                    ...
                    <svg className="md:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M3 5C3 3.89543 3.89543 3 5 3H8.27924C8.70967 3 9.09181 3.27543 9.22792 3.68377L10.7257 8.17721C10.8831 8.64932 10.6694 9.16531 10.2243 9.38787L7.96701 10.5165C9.06925 12.9612 11.0388 14.9308 13.4835 16.033L14.6121 13.7757C14.8347 13.3306 15.3507 13.1169 15.8228 13.2743L20.3162 14.7721C20.7246 14.9082 21 15.2903 21 15.7208V19C21 20.1046 20.1046 21 19 21H18C9.71573 21 3 14.2843 3 6V5Z" stroke="#595959" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    +234 7311067887
                  </div>
                  <div className="flex wow fadeIn md:text-white text-[16px] text-[#595959] font-[400] mb-[12px] gap-[12px]">
                    ...
                    <svg className="md:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M3 8L10.8906 13.2604C11.5624 13.7083 12.4376 13.7083 13.1094 13.2604L21 8M5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19Z" stroke="#595959" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
