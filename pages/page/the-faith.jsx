    ...
    <>
        ...
        <main className={`${inter.className}`}>
                    ...
                    <div className="md:w-[55%] wow fadeIn">
                        ...
                        <ul className="space-y-[14px]">
                            <div className="relative pl-[10px]">
                                ...
                                <li className="leading-[32px] text-[#595959] text-[16px] md:text-[18px] font-[400]">
            ...
            <section className="bg-transparent pt-[58px]">
                    ...
                    <div className="flex wow fadeInDown gap-[16px] md:gap-0 flex-col md:flex-row pb-[32px] justify-between">
                        <div className="md:w-[32.5%] bg-white rounded-[8px] p-[30px]">
                            ...
                            <div className="flex gap-[16px] mb-[16px]">
                                <figure className="">
                                    <Image src="/images/esmeralda.png" height={1} width={50} alt="user avatar" />
                                </figure>
                                <div className="">
                            ...
                            <p className="text-[#595959] text-[16px] md:text-[18px] font-[400]">
                        ...
                        <div className="md:w-[32.5%] bg-white rounded-[8px] p-[30px]">
                            ...
                            <div className="flex gap-[16px] mb-[16px]">
                                <figure className="">
                                    <Image src="/images/robert.png" height={1} width={50} alt="user avatar" />
                                </figure>
                                <div className="">
                ...
                <div className="w-[99%] bg-[#D51D13] h-[50px] md:h-[30px]"></div>
