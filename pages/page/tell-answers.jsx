                ...
                <div className="flex wow fadeIn flex-col gap-[24px] md:gap-0 md:flex-row mb-[24px] md:mb-[40px] justify-between">
                    ...
                    <div className="md:w-[48%] rounded-[16px] border border-[rgba(89, 89, 89, 0.20)] p-[15px]">
                        ...
                        <div className="text-[#595959] font-[400] text-[16px] md:text-[18px] leading-[32px]">
                            ...
                            <p className={`${testimonials.one == false ? "max-h-0" : "pt-[16px]"} text-[16px] overflow-hidden transition-[.4s] font-[400]`}>
                            ...
                            <p className={`text-[16px] ${testimonials.two == false ? "max-h-0" : "pt-[16px]"} font-[400] text-[16px] overflow-hidden transition-[.4s]`}>
                            ...
                            <p className={`${testimonials.three == false ? "max-h-0" : "pt-[16px]"} text-[16px] font-[400] overflow-hidden transition-[.4s]`}>
