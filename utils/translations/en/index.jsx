export const English = {
    ...
    pageTwo: {
        ...
        qanda: {
            qone: `Obedience to God's laws does not take you to heaven, rather belief in Jesus and Jesus’ obedience to God in your place assures you of salvation - if you remain in this faith. Obedience to God was required for those who lived under the law. That in order for them to be righteous, they needed to obey the whole law of God. In the New testament, under the new covenant, we are not demanded to OBEY law to be righteous, rather we have been made righteous as God's obedient ones through Christ obedience. Being grafted into Christ as a result of His death, burial and resurrection, you are one with Jesus and thus share in His obedience and subsequent righteousness. This gives us right standing with God and thus guarantees your salvation. When you are saved, you are expected to DO the word, not OBEY the word. You should do the word because you love God and not because you are obligated to and motivated by a consequence if you do not.`,
            pone: `Let's examine some scriptures:`,
            textone: `Galatians 2:16 KJV`,
            ptwo: `Knowing that a man is not justified by the works of the law, but by the faith of Jesus Christ, even we have believed in Jesus Christ, that we might be justified by the faith of Christ, and not by the works of the law: for by the works of the law shall no flesh be justified.`,
            texttwo: `John 14:23-24 KJV`,
            pthr: `Jesus answered and said unto him,`,
            underlineone: `If a man love me, he will keep my words:`,
            pfour: `and my Father will love him, and we will come unto him, and make our abode with him.`,
            ...
            psvn: `But now we are discharged from the Law and have terminated all intercourse with it, having died to what once restrained and held us captive.`,
            bone: `So now we serve not under [obedience to] the old code of written regulations, but [under obedience to the promptings] of the Spirit in newness [of life].`,
            textfiv: `Romans 8:13-14 KJV`,
            peit: `For if ye live after the flesh, ye shall die: but`,
            btwo: `if ye through the Spirit do mortify the deeds of the body, ye shall live. [14] For as many as are led by the Spirit of God, they are the sons of God.`,
            textsix: `Romans 6:8 KJV`,
            pnine: `Now if we be dead with Christ, we believe that we shall also,`,
            bthr: `we shall also live with him:`,
            qthr: `God does not judge you when you disobey`
        },
        sectionThr: {
